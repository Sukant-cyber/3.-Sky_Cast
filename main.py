...
root.geometry("800x400+200+100")         # All in sizes are in pixels
root.resizable(False, False)             # States that the window cannot be resized either horizontally or vertically


def getweather():
    try:
        city = text_field.get()           # Takes the input ciy name from user and stores in variable city
    ...
    # Add API Key Weather
        api = "https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=a294e19b92c6d2d929c02be39e42c76d"
